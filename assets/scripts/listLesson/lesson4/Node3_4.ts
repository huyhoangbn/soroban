...
@ccclass
export default class Node3_4 extends cc.Component {
    ...
    setAction(){
        ...
        let action4 = cc.callFunc(()=>{
            ...
            this.nodeHand.getComponent(sp.Skeleton).setAnimation(0,"animation",false);
            this.label_refer.string = "1 + 1 + 1 = 3";
            this.label_result.string = "3";
